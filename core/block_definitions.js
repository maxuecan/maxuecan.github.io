...
Blockly.Blocks['neopixel_write'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("写入颜色"), "MSG_NEOPIXEL");

    this.setPreviousStatement(true);
    this.setNextStatement(true);

    this.setColour(230);
    this.setTooltip("设置完颜色后调用写入");
    //this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['io_get'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("数字输入 IO")
    this.appendValueInput("set_pin_num");

    this.setInputsInline(true);
    this.setColour("#3c0");
    this.setOutput(true, null);
    //this.setTooltip("io_input_digital");
  }
};

// 设置高低
Blockly.Blocks['set_bool'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([
          ['高', '1'],
...
Blockly.Blocks['adc_input'] = {
  init: function() {
    ...
    this.setColour("#3c0");
    this.setOutput(true, null);
    //this.setTooltip("io_input_analogue");
  }
};

// 板载按键
Blockly.Blocks['set_io.bz_button'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("板载按键USR");
    this.setColour("#999");
...
// 180度舵机
Blockly.Blocks['actuator.servo180'] = {
  init: function() {
    this.appendDummyInput()
      .appendField("180°舵机 管脚 #");  
    this.appendValueInput("set_pin_num");
    this.appendDummyInput()
      .appendField(" 速度 ");
    this.appendValueInput("speed");
    this.appendDummyInput()
      .appendField(" 角度 ");
    this.appendValueInput("set_angle");
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("速度0-1；角度0-180")
  }
};

Blockly.Blocks['actuator.dir'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([
          ['正转', '1'],
...
// 360度舵机
Blockly.Blocks['actuator.servo360'] = {
  init: function() {
    this.appendDummyInput()
      .appendField("360°舵机 管脚 #");
    this.appendValueInput("set_pin_num");
    this.appendDummyInput()
      .appendField(" 方向 ");
    this.appendValueInput("dir");
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("速度：0-1")
  }
};

Blockly.Blocks['actuator.servo360_2'] = {
  init: function() {
    this.appendDummyInput()
      .appendField("360°舵机 管脚 #");
    this.appendValueInput("set_pin_num");
...
Blockly.Blocks['display.led_init'] = {
  init: function() {
    this.appendDummyInput()
      .appendField("RGB灯 初始化 ");
    ...
    this.appendDummyInput()
      .appendField(" 灯数 ");
    this.appendValueInput("lamp_count")
...
Blockly.Blocks['display.set_lamp_rgb'] = {
  init: function() {
    this.appendDummyInput()
      .appendField("RGB灯 ");
    this.appendValueInput("var_name");
    this.appendDummyInput()
      .appendField(" 灯号 ");
    this.appendValueInput("lamp_num");
    this.appendDummyInput()
      .appendField(" R值 ");
    this.appendValueInput("red");
    this.appendDummyInput()
  ...
  styleBlock: function(colours) {
    colours = colours.map(x => parseInt(x))
    colours = colours.includes(NaN) ? [153, 153, 255] : colours
    if(colours.every((e) => {return e <= 255}) && colours.every((e) => {return e >= 0})) {
      let hex_ = Tool.RGB2HEX (colours [0], colours [1], colours [2]);
      this.setColour(hex_);
    } else
...
Blockly.Blocks['display.rgb_fill'] = {
  init: function() {
    this.appendDummyInput()
      .appendField("RGB灯 ");
    this.appendValueInput("var_name");

...
(function(root, factory) {
    ...
    Blockly.Events.filter = function(a, b) {
        ...
        for (var c = [], d = Object.create(null), e = 0, f; f = a[e]; e++)
            if (!f.isNull()) {
                ...
                else if (f.type == Blockly.Events.CHANGE && f.element == k.element && f.name == k.name) k.newValue =
                    f.newValue;
                else if (f.type == Blockly.Events.VIEWPORT_CHANGE) k.viewTop = f.viewTop, k.viewLeft = f.viewLeft, k.scale = f.scale, k.oldScale = f.oldScale;
                else if (f.type != Blockly.Events.CLICK || k.type != Blockly.Events.BUBBLE_OPEN) d[g] = {
                    event: f,
                    index: e
                }, c.push(f)
    ...
    Blockly.Xml.domToBlockHeadless_ = function(a, b, c, d) {
        ...
        if (c)
            if (d)
                if (f.previousConnection) c.connect(f.previousConnection);
                else throw TypeError("Next block does not have previous statement.");
        else if (f.outputConnection) c.connect(f.outputConnection);
        else if (f.previousConnection) c.connect(f.previousConnection);
    ...
    Blockly.Events.Move.prototype.run = function(a) {
        ...
        if (c) {
            ...
            if (f) e = c.getRelativeToSurfaceXY(), c.moveBy(f.x - e.x, f.y - e.y);
            else {
    ...
    Blockly.Css.CONTENT = [
        ".blocklySvg {",  "background-color: #fff;",  "outline: none;",  "overflow: hidden;",  "position: absolute;",  "display: block;", "}", 
        ...
        ".blocklyNonSelectable {",  "user-select: none;",  "-ms-user-select: none;",  "-webkit-user-select: none;", "}", 
        ...
        ".blocklyBlockDragSurface {",  "display: none;",  "position: absolute;",  "top: 0;",  "left: 0;",  "right: 0;",  "bottom: 0;", 
            "overflow: visible !important;",  "z-index: 50;", "}", 
        ".blocklyBlockCanvas.blocklyCanvasTransitioning,", 
        ".blocklyBubbleCanvas.blocklyCanvasTransitioning {",  "transition: transform .5s;", "}", 
        ".blocklyTooltipDiv {",  "background-color: #ffffc7;",  "border: 1px solid #ddc;", 
            "box-shadow: 4px 4px 20px 1px rgba(0,0,0,.15);", "color: #000;",  "display: none;",  "font: 9pt sans-serif;", 
            "opacity: .9;",  "padding: 2px;",  "position: absolute;",  "z-index: 100000;", "}", 
        ".blocklyDropDownDiv {",  "position: absolute;",  "left: 0;",  "top: 0;",  "z-index: 1000;",  "display: none;", 
            "border: 1px solid;",  "border-color: #dadce0;",  "background-color: #fff;",  "border-radius: 2px;", 
            "padding: 4px;",  "box-shadow: 0 0 3px 1px rgba(0,0,0,.3);", "}", 
        ".blocklyDropDownDiv.blocklyFocused {",  "box-shadow: 0 0 6px 1px rgba(0,0,0,.3);", "}", 
        ".blocklyDropDownContent {",  "max-height: 300px;",  "overflow: auto;",  "overflow-x: hidden;",  "position: relative;", "}", 
        ".blocklyDropDownArrow {",  "position: absolute;",  "left: 0;",  "top: 0;",  "width: 16px;",  "height: 16px;", 
            "z-index: -1;",  "background-color: inherit;",  "border-color: inherit;", "}", 
        ".blocklyDropDownButton {",  "display: inline-block;",  "float: left;",  "padding: 0;",  "margin: 4px;", 
            "border-radius: 4px;",  "outline: none;",  "border: 1px solid;",  "transition: box-shadow .1s;",  "cursor: pointer;", "}", 
        ".blocklyArrowTop {",  "border-top: 1px solid;", "border-left: 1px solid;",  "border-top-left-radius: 4px;", 
            "border-color: inherit;", "}", 
        ".blocklyArrowBottom {",   "border-bottom: 1px solid;",  "border-right: 1px solid;",  "border-bottom-right-radius: 4px;", 
            "border-color: inherit;", "}", 
        ...
        ".blocklyDraggable {",  'cursor: url("<<<PATH>>>/handopen.cur"), auto;',  "cursor: grab;",  "cursor: -webkit-grab;", "}", 
        ".blocklyDragging {",  'cursor: url("<<<PATH>>>/handclosed.cur"), auto;',  "cursor: grabbing;",  
            "cursor: -webkit-grabbing;", "}", 
        ".blocklyDraggable:active {",  'cursor: url("<<<PATH>>>/handclosed.cur"), auto;',  "cursor: grabbing;", 
            "cursor: -webkit-grabbing;", "}", 
        ...
        ".blocklyDragging>.blocklyPathLight {",  "fill-opacity: .8;",  "stroke-opacity: .8;", "}", 
        ...
        ".blocklyInsertionMarker>.blocklyPathDark {",  "fill-opacity: .2;",  "stroke: none;", "}", 
        ...
        ".blocklySvg text,",
        ".blocklyBlockDragSurface text {",  "user-select: none;",  "-ms-user-select: none;",  "-webkit-user-select: none;", 
            "cursor: inherit;", "}", 
        ".blocklyHidden {",  "display: none;", "}", 
        ".blocklyFieldDropdown:not(.blocklyHidden) {",  "display: block;", "}", 
        ".blocklyIconGroup {", "cursor: default;", "}", 
        ".blocklyIconGroup:not(:hover),",  
        ".blocklyIconGroupReadonly {",  "opacity: .6;", "}", 
        ...
        ".blocklyFlyoutBackground {",  "fill: #ddd;",  "fill-opacity: 0.8;", "}", 
        ".blocklyMainWorkspaceScrollbar {",  "z-index: 20;", "}", 
        ".blocklyFlyoutScrollbar {",  "z-index: 30;", "}", 
        ".blocklyScrollbarHorizontal,",  
        
        ".blocklyScrollbarVertical {", "position: absolute;", "outline: none;", "}", 
        ...
        ".blocklyVerticalMarker {", "stroke-width: 3px;", "fill: rgba(255,255,255,.5);", "pointer-events: none;", "}", 
        ...
        ".blocklyDropdownMenu .blocklyMenuItem {", "padding-left: 28px;", "}", 
        ".blocklyDropdownMenu .blocklyMenuItemRtl {", "padding-left: 5px;", "padding-right: 28px;", "}", 
        ".blocklyWidgetDiv .blocklyMenu {", "background: #fff;", "border: 1px solid transparent;", "box-shadow: 0 0 3px 1px rgba(0,0,0,.3);", 
        ...
        ".blocklyWidgetDiv.blocklyMenu.blocklyFocused {",  "box-shadow: 0 0 6px 1px rgba(0,0,0,.3);", "}", 
        ".blocklyDropDownContent {", "max-height: 300px;",  "overflow: auto;",  "overflow-x: hidden;",  "position: relative;", "}", 
        ".blocklyDropDownDiv.blocklyMenu {",  "background: inherit;",  "border: inherit;",  'font: normal 13px "Helvetica Neue", Helvetica, sans-serif;', 
            "outline: none;",  "position: relative;",  "z-index: 20000;", "}", 
        ".blocklyMenuItem {",  "border: none;",  "color: #000;",  "cursor: pointer;",  "list-style: none;",  "margin: 0;",  "min-width: 7em;", 
        ...
        ".blocklyMenuItemCheckbox {",  "height: 16px;",  "position: absolute;", "width: 16px;", "}", 
        ".blocklyMenuItemSelected.blocklyMenuItemCheckbox {",  "background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px;",  
            "float: left;",  "margin-left: -24px;",  "position: static;", "}", 
        ".blocklyMenuItemRtl.blocklyMenuItemCheckbox {",  "float: right;",  "margin-right: -24px;", "}"
    ];
    ...
    Blockly.utils.IdGenerator.nextUId_ = 0;
    Blockly.utils.IdGenerator.getNextUniqueId = function() {
        return "blockly-" + (Blockly.utils.IdGenerator.nextId_++).toString(36)
    };
    Blockly.utils.IdGenerator.getNextUId = function() {
        return Blockly.utils.IdGenerator.nextUId_++;
    };
    ...
    Blockly.utils.toolbox.addAttributes_ = function(a, b) {
        for (var c = 0; c < a.attributes.length; c++) {
            var d = a.attributes[c]; - 1 < d.nodeName.indexOf("css-") ? (b.cssconfig = b.cssconfig || {}, b.cssconfig[d.nodeName.replace("css-", "")] = d.value) : b[d.nodeName] = d.value
        }
    };
    ...
    Blockly.Scrollbar.prototype.resizeContentHorizontal = function(a) {
        if (a.viewWidth >= a.scrollWidth) this.setHandleLength_(this.scrollbarLength_), this.setHandlePosition(0), this.pair_ || this.setVisible(!1);
        else {
    ...
    Blockly.Scrollbar.prototype.resizeContentVertical = function(a) {
        if (a.viewHeight >= a.scrollHeight) this.setHandleLength_(this.scrollbarLength_), this.setHandlePosition(0), this.pair_ || this.setVisible(!1);
        else {
            this.pair_ || this.setVisible(!0);
    ...
    Blockly.Connection.prototype.connect_ = function(a) {
        ...
        if (g)
            if (a = this.type === b ? g.outputConnection : g.previousConnection, d = Blockly.Connection.getConnectionForOrphanedConnection(d, a)) a.connect(d);
    ...
    Blockly.BlockDragger.prototype.endDrag = function(a, b) {
        ...
        Blockly.blockAnimations.disconnectUiStop();
        if (this.dragTarget_ && this.dragTarget_.shouldPreventMove(this.draggingBlock_)) a = this.startXY_;
        else {
    ...
    Blockly.Bubble.prototype.getOptimalRelativeLeft_ = function(a) {
        ...
        else d = b + this.anchorXY_.x, c = d + this.width_, f = a.left, e = a.left + a.width - Blockly.Scrollbar.scrollbarThickness / this.workspace_.scale;
    ...
    Blockly.WorkspaceDragger.prototype.drag = function(a) {
        ...
        if (this.horizontalScrollEnabled_ && this.verticalScrollEnabled_) this.workspace_.scroll(a.x, a.y);
        else if (this.horizontalScrollEnabled_) this.workspace_.scroll(a.x, this.workspace_.scrollY);
        else if (this.verticalScrollEnabled_) this.workspace_.scroll(this.workspace_.scrollX, a.y);
    ...
    Blockly.Gesture.prototype.doBlockClick_ = function() {
        if (this.flyout_ && this.flyout_.autoClose) this.targetBlock_.isEnabled() && (Blockly.Events.getGroup() || Blockly.Events.setGroup(!0), this.flyout_.createBlock(this.targetBlock_).scheduleSnapAndBump());
        else {
    ...
    Blockly.Block.prototype.unplugFromRow_ = function(a) {
        ...
        if (b && a && (a = this.getOnlyValueConnection_()) && a.isConnected() && !a.targetBlock().isShadow())
            if (a = a.targetConnection, a.disconnect(), this.workspace.connectionChecker.canConnect(a, b, !1)) b.connect(a);
    ...
    Blockly.Block.prototype.setNextStatement = function(a, b) {
        if (a) void 0 === b && (b = null), this.nextConnection || (this.nextConnection = this.makeConnection_(Blockly.connectionTypes.NEXT_STATEMENT)), this.nextConnection.setCheck(b);
    ...
    Blockly.Block.prototype.jsonInit = function(a) {
        ...
        a = a.extensions;
        if (Array.isArray(a))
            for (b = 0; b < a.length; ++b) Blockly.Extensions.apply(a[b], this, !1)
    };
    ...
    Blockly.MetricsManager.prototype.getViewMetrics = function(a) {
        ...
        if (this.workspace_.getToolbox())
            if (e == Blockly.utils.toolbox.Position.TOP || e == Blockly.utils.toolbox.Position.BOTTOM) b.height -= c.height;
            else {
            ...
            if (e ==
                Blockly.utils.toolbox.Position.TOP || e == Blockly.utils.toolbox.Position.BOTTOM) b.height -= d.height;
            else if (e == Blockly.utils.toolbox.Position.LEFT || e == Blockly.utils.toolbox.Position.RIGHT) b.width -= d.width;
        return {
            height: b.height / a,
            width: b.width / a,
    ...
    Blockly.WorkspaceSvg.prototype.setVisible = function(a) {
        this.isVisible_ = a;
        if (this.svgGroup_)
            if (this.scrollbar && this.scrollbar.setContainerVisible(a), this.getFlyout() && this.getFlyout().setContainerVisible(a), this.getParentSvg().style.display = a ? "block" : "none", this.toolbox_ && this.toolbox_.setVisible(a), a) {
                ...
                Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, f, function(g) {
                    if (g) {
                        ...
                        if (h) {
                            ...
                            else k = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE, k = k.replace("%1", h.name).replace("%2", h.type);
    ...
    Blockly.Flyout.prototype.filterForCapacity_ = function() {
        for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; c = a[b]; b++)
            if (-1 == this.permanentlyDisabled_.indexOf(c))
                for (var d = this.targetWorkspace.isCapacityAvailable(Blockly.utils.getBlockTypeCounts(c)); c;) c.setEnabled(d), c = c.getNextBlock()
    };
    ...
    Blockly.ToolboxCategory.prototype.createDom_ = function() {
        this.uid_ = Blockly.utils.IdGenerator.getNextUId();
        ...
        this.rowDiv_.style.backgroundColor = "#f0f0f0";//this.colour_;
        this.iconDom_.style.borderColor = this.colour_;
    ...
    Blockly.ToolboxCategory.prototype.createIconDom_ = function() {
        ...
        var uid = this.uid_ - 1;
        a.className = "toolItemIcon";
        let l = -1.25 * uid;
        a.style.backgroundPosition = `${l}rem 0`;
    ...
    Blockly.ToolboxCategory.prototype.setSelected = function(a) {
        if (a) {
            ...
            //this.rowDiv_.style.backgroundColor = "#eee" || b;
            this.labelDom_.style.color = "#eee";   
            //this.iconDom_.style.backgroundPosition = `calc(-1.25rem*${this.uid_ - 1}) 1.25rem`;
            Blockly.utils.dom.addClass(this.rowDiv_, this.cssConfig_.selected);
        } else {
            this.rowDiv_.style.backgroundColor = "#f0f0f0";
            //this.rowDiv_.style.backgroundColor = this.colour_;
            this.labelDom_.style.color = "black";
            //this.iconDom_.style.backgroundPosition = `calc(-1.25rem*${this.uid_ - 1}) 0`;
    ...
    Blockly.CollapsibleToolboxCategory.prototype.setExpanded = function(a) {
        this.expanded_ != a && ((this.expanded_ = a) ? (this.subcategoriesDiv_.style.display = "block", 
            this.openIcon_(this.iconDom_)) : (this.subcategoriesDiv_.style.display = "none", this.closeIcon_(this.iconDom_)), 
            Blockly.utils.aria.setState(this.htmlDiv_, Blockly.utils.aria.State.EXPANDED, a), this.parentToolbox_.handleToolboxItemResize())
    };
    ...
    Blockly.Toolbox.prototype.onClick_ = function(a) {
        if (Blockly.utils.isRightButton(a) || a.target == this.HtmlDiv) Blockly.hideChaff(!1);
        else {
    ...
    Blockly.Toolbox.prototype.createToolboxItem_ = function(a, b) {
        var c = a.kind;
        "CATEGORY" == c.toUpperCase() && Blockly.utils.toolbox.isCategoryCollapsible(a) && 
        ...
        if (c = Blockly.registry.getClass(Blockly.registry.Type.TOOLBOX_ITEM, c.toLowerCase()))
            a = new c(a, this),this.addToolboxItem_(a),a.init(),
        (c = a.getDiv()) && b.appendChild(c), a.getClickTarget && a.getClickTarget().setAttribute("id", a.getId())
        };
    ...
    Blockly.Toolbox.prototype.setSelectedItem = function(a) {
        ...
        !a && !b || a && !a.isSelectable() || (this.shouldDeselectItem_(b, a) && 
        null != b && this.deselectItem_(b), this.shouldSelectItem_(b, a) && 
        null != a && this.selectItem_(b, a), this.updateFlyout_(b, a), this.fireSelectEvent_(b, a))
    };
    ...
    Blockly.ContextMenuItems.toggleOption_ = function(a, b) {
        for (var c = 0, d = 0; d < b.length; d++)
            for (var e = b[d]; e;) setTimeout(e.setCollapsed.bind(e, a), c), e = e.getNextBlock(), c += 10
    };
    ...
    Blockly.Mutator.prototype.updateBlockStyle = function() {
        ...
        if (a && a.getAllBlocks(!1)) {
            ...
            if (c = a.getFlyout())
                for (a = c.workspace_.getAllBlocks(!1), c = 0; d = a[c]; c++) d.setStyle(d.getStyleName())
        }
    };
    ...
    Blockly.FieldNumber.prototype.setPrecisionInternal_ = function(a) {
        ...
        var b = String(this.precision_); - 1 != b.indexOf("e") && (b = this.precision_.toLocaleString("en-US", {
    ...
    Blockly.zelos.ConstantProvider.prototype.createDom = function(a, b, c) {
        ...
        c =
            Blockly.utils.dom.createSvgElement(Blockly.utils.Svg.FECOMPONENTTRANSFER, {
                result: "outBlur"
            }, b);
    ...
    Blockly.zelos.PathObject.prototype.endDrawing = function() {
        if (this.remainingOutlines_)
            for (var a in this.remainingOutlines_) this.removeOutlinePath_(a);

...
// 数字输入
Blockly.Python['io_get'] = function(block){
  var value_pin = Blockly.Python.valueToCode(block, 'set_pin_num', Blockly.Python.ORDER_ATOMIC);
  Blockly.Python.definitions_['import_pin'] = 'from machine import Pin';
  var x = value_pin.replace('(','').replace(')','');

  Blockly.Python.definitions_[`io_get_${x}`] = `pIn${x} = Pin(${x}, Pin.IN, Pin.PULL_UP)\n`
  var code = `pIn${x}.value()`;
  return [code, Blockly.Python.ORDER_NONE];
};

// 设置高/低
Blockly.Python['set_bool'] = function(block){
...
Blockly.Python['adc_input'] = function(block){
  ...
  Blockly.Python.definitions_[`adc_input${x}`] = `adc${x} = ADC(${x})`;
...
// 板载按键
Blockly.Python['set_io.bz_button'] = function(block){
	var code = "io_input_bz_button"
	return code;
};

Blockly.Python['main_loop'] = function(block){
  var funct_code = Blockly.Python.statementToCode(block, 'do');
  if (funct_code == "") funct_code = "pass"
...
// 数字输出
Blockly.Python['io_set'] = function(block){
  var value_pin = Blockly.Python.valueToCode(block, 'set_pin_num', Blockly.Python.ORDER_ATOMIC);
  var value = block.getFieldValue('value');

  Blockly.Python.definitions_['import_pin'] = 'from machine import Pin';
  Blockly.Python.definitions_['io_set'] = 'def gpio_set(pin,value):\n  if value >= 1:\n    Pin(pin, Pin.OUT).on()\n  else:\n    Pin(pin, Pin.OUT).off()';

  var code = `gpio_set(${value_pin}, ${value})\n`;
  return code;
};

// 模拟输出
Blockly.Python['pwm_set'] = function(block){
  var value_pin = Blockly.Python.valueToCode(block, 'set_pin_num', Blockly.Python.ORDER_NONE);
	var value_duty = Blockly.Python.valueToCode(block, 'set_value', Blockly.Python.ORDER_ATOMIC);
	Blockly.Python.definitions_['import_pin'] = 'from machine import Pin';
	Blockly.Python.definitions_['import_pwm'] = 'from machine import PWM';

  //this.check([value_frequency,value_duty], value_pin);
  //this.setID(value_pin)
	var code = `pwm${value_pin} = PWM(Pin(${value_pin}))\npwm${value_pin}.freq(1000)\npwm${value_pin}.duty_u16(${value_duty})\n`;
	return code;
};
...
Blockly.Python['print_line'] = function(block){
...
// 180度舵机
Blockly.Python['actuator.servo180'] = function(block) {
  var value_pin = Blockly.Python.valueToCode(block, 'set_pin_num', Blockly.Python.ORDER_ATOMIC);
  var speed = Blockly.Python.valueToCode(block, 'speed', Blockly.Python.ORDER_ATOMIC);
  var angle = Blockly.Python.valueToCode(block, 'set_angle', Blockly.Python.ORDER_ATOMIC);

  Blockly.Python.definitions_['import_servo'] = 'import servo';

  var code = `servo180 = servo.Servo180(pin=${value_pin})\nservo180.rotate_to_angle(target_angle=${angle}, speed=${speed})\n`;
  return code;
}

Blockly.Python['actuator.dir'] = function(block) {
  var dir = block.getFieldValue('dir');
	return [dir, Blockly.Python.ORDER_NONE];
}

// 360度舵机
Blockly.Python['actuator.servo360'] = function(block) {
  var value_pin = Blockly.Python.valueToCode(block, 'set_pin_num', Blockly.Python.ORDER_ATOMIC);
  var speed = Blockly.Python.valueToCode(block, 'speed', Blockly.Python.ORDER_ATOMIC);
  var dir = Blockly.Python.valueToCode(block, 'dir', Blockly.Python.ORDER_ATOMIC);
  ...
  var code = `servo360 = servo.Servo360(pin=${value_pin})\nservo360.rotate(speed=${speed}, dir=${dir}, rotate_time=-1)\n`;
  return code;
}

Blockly.Python['actuator.servo360_2'] = function(block) {
  var value_pin = Blockly.Python.valueToCode(block, 'set_pin_num', Blockly.Python.ORDER_ATOMIC);
  var speed = Blockly.Python.valueToCode(block, 'speed', Blockly.Python.ORDER_ATOMIC);
  var dir = Blockly.Python.valueToCode(block, 'dir', Blockly.Python.ORDER_ATOMIC);
  ...
  var code = `servo360 = servo.Servo360(pin=${value_pin})\nservo360.rotate(speed=${speed}, dir=${dir}, rotate_time=${time})\n`;
  return code;
}
...
// led初始化
Blockly.Python['display.led_init'] = function(block) {
  var value_pin = Blockly.Python.valueToCode(block, 'set_pin_num', Blockly.Python.ORDER_ATOMIC);
  var value = Blockly.Python.valueToCode(block, 'lamp_count', Blockly.Python.ORDER_ATOMIC);
  var var_name = Blockly.Python.valueToCode(block, 'var_name', Blockly.Python.ORDER_ATOMIC);

  Blockly.Python.definitions_['import_machine'] = 'import machine';
  Blockly.Python.definitions_['import_neopixel'] = 'import neopixel';

  var code = `${var_name} = neopixel.NeoPixel(machine.Pin(${value_pin}), ${value})\n`;
  return code;
}

Blockly.Python['display.set_lamp_rgb'] = function(block) {
  var var_name = Blockly.Python.valueToCode(block, 'var_name', Blockly.Python.ORDER_ATOMIC);
  var lamp_num = Blockly.Python.valueToCode(block, 'lamp_num', Blockly.Python.ORDER_ATOMIC);
  ...
  var code = `${var_name}[${lamp_num}] = (${red}, ${green}, ${blue})\n`;
  return code;
}

Blockly.Python['display.rgb_fill'] = function(block) {
  var var_name = Blockly.Python.valueToCode(block, 'var_name', Blockly.Python.ORDER_ATOMIC);
  var red = Blockly.Python.valueToCode(block, 'red', Blockly.Python.ORDER_ATOMIC);
  var green = Blockly.Python.valueToCode(block, 'green', Blockly.Python.ORDER_ATOMIC);
  var blue = Blockly.Python.valueToCode(block, 'blue', Blockly.Python.ORDER_ATOMIC);
  ...
  this.styleBlock([red, green, blue]);
  var code = `${var_name}.fill((${red}, ${green}, ${blue}))\n`;
  return code;
}

Blockly.Python['write_rgb'] = function(block) {
  var var_name = Blockly.Python.valueToCode(block, 'var_name', Blockly.Python.ORDER_ATOMIC);
  var code = `${var_name}.write()\n`;
  return code;
}
...
Blockly.Python['oled_write'] = function(block) {
  var text = Blockly.Python.valueToCode(block, 'text', Blockly.Python.ORDER_ATOMIC);
  var x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_ATOMIC);
  var y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_ATOMIC);
  var code = `oled.text(${text}, ${x}, ${y})\noled.show()\n`;
  return code;
}